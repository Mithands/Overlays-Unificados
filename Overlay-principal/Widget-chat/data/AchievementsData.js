...
export const ACHIEVEMENTS_DATA = {
    ...
    achievements: {
        ...
        tw3_stream_10: {
            ...
            rarity: "epic",
            icon: "🗺️",
            image: "img/logros/Nightingale_first.png",
            rule: { field: "stats.witcher3Streams", operator: ">=", value: 10 },
            gameCategory: "The Witcher 3: Wild Hunt"
        },

        // ==================== NIGHTINGALE ====================
        nightingale_first_contact: {
            name: "Bienvenido a Nightingale",
            description: "Primer contacto con el reino de Nightingale",
            condition: "Escribir tu primer mensaje mientras jugamos Nightingale",
            category: "nightingale",
            rarity: "common",
            icon: "🌌",
            image: "img/logros/Nightingale_first.png",
            rule: { field: "stats.nightingaleMessages", operator: ">=", value: 1 },
            gameCategory: "Nightingale"
        },
        nightingale_explorer: {
            name: "Explorador de Nightingale",
            description: "Has recorrido los portales de Nightingale",
            condition: "10 mensajes en la categoría Nightingale",
            category: "nightingale",
            rarity: "uncommon",
            icon: "🏹",
            image: "img/logros/Nightingale_first.png",
            rule: { field: "stats.nightingaleMessages", operator: ">=", value: 10 },
            gameCategory: "Nightingale"
        },
        nightingale_next_biome: {
            name: "¿Siguiente Bioma?",
            description: "Buscando nuevos horizontes en Nightingale",
            condition: "20 mensajes en la categoría Nightingale",
            category: "nightingale",
            rarity: "rare",
            icon: "🧭",
            image: "img/logros/Nightingale_first.png",
            rule: { field: "stats.nightingaleMessages", operator: ">=", value: 20 },
            gameCategory: "Nightingale"
        },

        // ==================== RUST ====================
        rust_first_contact: {
            name: "Bienvenido a Rust",
            description: "Sobreviviendo a la naturaleza",
            condition: "Escribir tu primer mensaje mientras jugamos Rust",
            category: "rust",
            rarity: "common",
            icon: "⛺",
            image: "img/logros/default.png",
            rule: { field: "stats.rustMessages", operator: ">=", value: 1 },
            gameCategory: "Rust"
        },

        // ==================== APEX LEGENDS ====================
        apex_first_contact: {
            name: "Bienvenido a Apex Legends",
            description: "Convertido en Leyenda",
            condition: "Escribir tu primer mensaje mientras jugamos Apex Legends",
            category: "apex",
            rarity: "common",
            icon: "🏆",
            image: "img/logros/default.png",
            rule: { field: "stats.apexMessages", operator: ">=", value: 1 },
            gameCategory: "Apex Legends"
        },

        // ==================== SCUM ====================
        scum_first_contact: {
            name: "Bienvenido a SCUM",
            description: "Prisionero en la isla",
            condition: "Escribir tu primer mensaje mientras jugamos SCUM",
            category: "scum",
            rarity: "common",
            icon: "⛓️",
            image: "img/logros/default.png",
            rule: { field: "stats.scumMessages", operator: ">=", value: 1 },
            gameCategory: "SCUM"
        },

        // ==================== STAR WARS OUTLAWS ====================
        starwars_first_contact: {
            name: "Bienvenido a Star Wars Outlaws",
            description: "En una galaxia muy, muy lejana",
            condition: "Escribir tu primer mensaje mientras jugamos Star Wars Outlaws",
            category: "starwars",
            rarity: "common",
            icon: "🌌",
            image: "img/logros/default.png",
            rule: { field: "stats.starwarsMessages", operator: ">=", value: 1 },
            gameCategory: "Star Wars Outlaws"
        },

        // ==================== ARC RAIDERS ====================
        arcraiders_first_contact: {
            name: "Bienvenido a ARC Raiders",
            description: "Resistiendo a la amenaza mecánica",
            condition: "Escribir tu primer mensaje mientras jugamos ARC Raiders",
            category: "arcraiders",
            rarity: "common",
            icon: "🤖",
            image: "img/logros/default.png",
            rule: { field: "stats.arcraidersMessages", operator: ">=", value: 1 },
            gameCategory: "ARC Raiders"
        },

        // ==================== MINECRAFT ====================
        minecraft_first_contact: {
            name: "Bienvenido a Minecraft",
            description: "Pinchando bloques",
            condition: "Escribir tu primer mensaje mientras jugamos Minecraft",
            category: "minecraft",
            rarity: "common",
            icon: "🧱",
            image: "img/logros/default.png",
            rule: { field: "stats.minecraftMessages", operator: ">=", value: 1 },
